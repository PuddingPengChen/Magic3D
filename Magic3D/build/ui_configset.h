...
public:
    ...
    void setupUi(QDialog *ConfigSet)
    {
        if (ConfigSet->objectName().isEmpty())
            ConfigSet->setObjectName(QString::fromUtf8("ConfigSet"));
        ConfigSet->resize(400, 251);
        ConfigSet->setStyleSheet(QString::fromUtf8("QRadioButton\n"
"{\n"
...
"}"));
        ...
        frame_title_2->setObjectName(QString::fromUtf8("frame_title_2"));
        frame_title_2->setGeometry(QRect(-1, 1, 402, 21));
        frame_title_2->setStyleSheet(QString::fromUtf8("QFrame\n"
"{\n"
...
"}"));
    ...
    {
        ConfigSet->setWindowTitle(QApplication::translate("ConfigSet", "Dialog", 0, QApplication::UnicodeUTF8));
        label->setText(QApplication::translate("ConfigSet", "Please choose your machine:", 0, QApplication::UnicodeUTF8));
        radioButton->setText(QApplication::translate("ConfigSet", "GuangSu-1024x768", 0, QApplication::UnicodeUTF8));
        radioButton_2->setText(QApplication::translate("ConfigSet", "GuangSu-1920x1080", 0, QApplication::UnicodeUTF8));
        OK_pushButton->setText(QApplication::translate("ConfigSet", "OK", 0, QApplication::UnicodeUTF8));
    } // retranslateUi
